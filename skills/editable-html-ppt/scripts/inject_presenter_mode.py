#!/usr/bin/env python3
"""Inject presenter mode runtime into an existing HTML deck."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Inject presenter mode into an existing HTML PPT deck.")
