...
现在它可以是一个链接就可以被大家看到、有高级交互感、可随时编辑、插入图片、且拥有计时演讲功能的小型网页作品。

xiaoshui-Pretty PPT 是一个给 Claude Code / Codex / Workbuddy 等 Coding Agent 使用的网页 PPT Skill。你把文章、飞书文档、截图、数据、旧 PPT 交给它，它会帮你判断场景、选择模板、拆页面、提重点，生成一份能翻页、能编辑、能演示、能发布的 **HTML 网页 PPT**。


它内置 12 套设计风格，并加入了编辑模式、演讲者模式、插入图片、字号调整和计时器，

适合自媒体分享、作品集展示、课程产品、商务汇报、行政政务和产品演讲等多个场景。你不用先手动排版，也不用从空白页开始做 PPT，重点是把想法变成一份可以讲出来的作品。
