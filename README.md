...
你可能已经有文章、飞书文档、截图、数据，甚至一份旧 PPT。现在，这些材料可以变成一份通过链接分享、带有交互动效、支持编辑、插入图片和演讲计时的 HTML 网页 PPT。

它适用于 Claude Code、Codex、WorkBuddy 等 **Coding Agent**。你把材料交给它，它会判断场景、选择模板、拆分页面、提炼重点，生成一份能翻页、能编辑、能演示、能发布的网页作品。

它根据场景与人群分类，内置 12 套设计风格。你只需要专注于内容和想法，把它变成一份真正可以讲出来的作品。
